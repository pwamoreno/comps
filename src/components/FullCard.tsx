  ...
  return (
    <div className="max-w-[250px] mx-auto">
      <div className="relative bg-neutral-900 rounded-3xl overflow-hidden shadow-xl">
        ...
        <div className="absolute bottom-0 w-full px-4 pb-4 pt-6 bg-gradient-to-t from-black/40 via-black/20 to-transparent backdrop-blur-md">
          <div className="flex items-center gap-2">
            <h2 className="text-lg font-semibold text-white">{userObj.name}</h2>
